...
import type { CriteriaFilterDtoClass } from '@shared-kernel/common/infrastructure/graphql/classes/criteria-filter.dto.class';
import type { CriteriaSortDtoClass } from './criteria-sort.dto.class';
